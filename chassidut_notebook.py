...
# The following code can be run in a Jupyter notebook
print("Loading Chassidut texts and preparing context...")
chassidut_texts = load_chassidut_texts()
context = prepare_context(chassidut_texts)

print("\nExample of loaded texts:")
...
print("\nReady to answer questions about Chassidut!")
print("Example usage in Jupyter notebook:")
print("response = query_gemini('What does Chassidut teach about joy?', context)")
